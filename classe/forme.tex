...
\titleformat{\chapter}[frame]{\normalfont\scshape}{\Large\filcenter\enspace\chaptername\hspace{0.3cm}\thechapter\enspace}{12pt}{\thispagestyle{empty}\Huge\filcenter} % Nouvelle forme des chapitres
